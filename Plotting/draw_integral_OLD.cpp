...
//          auto dataframe_data_layer_eta_ladderblade = complete_dataframe_data.Filter( cutEqualLayer, { variable_layer + std::to_string(iHit) + "_best_track" } )
...
//          
//          auto dataframe_mc_layer_eta_ladderblade   = complete_dataframe_mc  .Filter( cutEqualLayer, { variable_layer + std::to_string(iHit) + "_best_track" } )
//                                                                             .Filter ( cutFindEdgeAbs, { variable_eta + "_best_track" } )
//                                                                             .Filter( cutEqualBadderOrBlade, { variable_ladder_blade + std::to_string(iHit) + "_best_track" } );      
