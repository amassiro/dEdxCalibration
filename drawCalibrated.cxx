...
void drawCalibrated(std::string name_input_file_data = "out.root", std::string name_input_file_mc = "out.root", std::string fileCalibration = "calibration.txt", std::string name_output_file = "calibrated.root"){
  ...
  for (int i=0; i<calibration_values.size(); i++) {
    std::cout << " [" << i << "] = " << calibration_values.at(i) << std::endl;
  }
...
//   for (int iEntry=0; iEntry<5000; iEntry++) {
    ...
    if (best_iMuon != -1) {
      ...
      if (best_track != -1) {
        ...
        h_dedxByLayer0_data ->Fill(IsoTrack_dedxByLayer0 [best_track]   * calibration_values.at(0 )  );
        h_dedxByLayer1_data ->Fill(IsoTrack_dedxByLayer1 [best_track]   * calibration_values.at(1 )  );
        h_dedxByLayer2_data ->Fill(IsoTrack_dedxByLayer2 [best_track]   * calibration_values.at(2 )  );
        h_dedxByLayer3_data ->Fill(IsoTrack_dedxByLayer3 [best_track]   * calibration_values.at(3 )  );
        h_dedxByLayer4_data ->Fill(IsoTrack_dedxByLayer4 [best_track]   * calibration_values.at(4 )  );
        h_dedxByLayer5_data ->Fill(IsoTrack_dedxByLayer5 [best_track]   * calibration_values.at(5 )  );
        h_dedxByLayer6_data ->Fill(IsoTrack_dedxByLayer6 [best_track]   * calibration_values.at(6 )  );
        h_dedxByLayer7_data ->Fill(IsoTrack_dedxByLayer7 [best_track]   * calibration_values.at(7 )  );
        h_dedxByLayer8_data ->Fill(IsoTrack_dedxByLayer8 [best_track]   * calibration_values.at(8 )  );
        h_dedxByLayer9_data ->Fill(IsoTrack_dedxByLayer9 [best_track]   * calibration_values.at(9 )  );
        h_dedxByLayer10_data->Fill(IsoTrack_dedxByLayer10[best_track]   * calibration_values.at(10)  );
        h_dedxByLayer11_data->Fill(IsoTrack_dedxByLayer11[best_track]   * calibration_values.at(11)  );
        h_dedxByLayer12_data->Fill(IsoTrack_dedxByLayer12[best_track]   * calibration_values.at(12)  );
        h_dedxByLayer13_data->Fill(IsoTrack_dedxByLayer13[best_track]   * calibration_values.at(13)  );
