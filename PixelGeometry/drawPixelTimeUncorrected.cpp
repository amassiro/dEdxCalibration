...
int main(int argc, char** argv) {
  ...
  //   IsoTrack_dedxUnSmearedByLayer0
  ...
  Float_t IsoTrack_dedxUnSmearedByLayer0[kMaxTracks];
  Float_t IsoTrack_dedxUnSmearedByLayer1[kMaxTracks];
  Float_t IsoTrack_dedxUnSmearedByLayer2[kMaxTracks];
  Float_t IsoTrack_dedxUnSmearedByLayer3[kMaxTracks];
  Float_t IsoTrack_dedxUnSmearedByLayer4[kMaxTracks];
  Float_t IsoTrack_dedxUnSmearedByLayer5[kMaxTracks];
  Float_t IsoTrack_dedxUnSmearedByLayer6[kMaxTracks];
  Float_t IsoTrack_dedxUnSmearedByLayer7[kMaxTracks];
  Float_t IsoTrack_dedxUnSmearedByLayer8[kMaxTracks];
  Float_t IsoTrack_dedxUnSmearedByLayer9[kMaxTracks];
  Float_t IsoTrack_dedxUnSmearedByLayer10[kMaxTracks];
  Float_t IsoTrack_dedxUnSmearedByLayer11[kMaxTracks];
  Float_t IsoTrack_dedxUnSmearedByLayer12[kMaxTracks];
  Float_t IsoTrack_dedxUnSmearedByLayer13[kMaxTracks];
  ...
  inputTree_data->SetBranchAddress("IsoTrack_dedxUnSmearedByLayer0",  IsoTrack_dedxUnSmearedByLayer0);                                         
  inputTree_mc  ->SetBranchAddress("IsoTrack_dedxUnSmearedByLayer0",  IsoTrack_dedxUnSmearedByLayer0);                                         
  
  inputTree_data->SetBranchAddress("IsoTrack_dedxUnSmearedByLayer1",  IsoTrack_dedxUnSmearedByLayer1);                                         
  inputTree_mc  ->SetBranchAddress("IsoTrack_dedxUnSmearedByLayer1",  IsoTrack_dedxUnSmearedByLayer1);                                         
  
  inputTree_data->SetBranchAddress("IsoTrack_dedxUnSmearedByLayer2",  IsoTrack_dedxUnSmearedByLayer2);                                         
  inputTree_mc  ->SetBranchAddress("IsoTrack_dedxUnSmearedByLayer2",  IsoTrack_dedxUnSmearedByLayer2);                                         
  
  inputTree_data->SetBranchAddress("IsoTrack_dedxUnSmearedByLayer3",  IsoTrack_dedxUnSmearedByLayer3);                                         
  inputTree_mc  ->SetBranchAddress("IsoTrack_dedxUnSmearedByLayer3",  IsoTrack_dedxUnSmearedByLayer3);                                         
  
  inputTree_data->SetBranchAddress("IsoTrack_dedxUnSmearedByLayer4",  IsoTrack_dedxUnSmearedByLayer4);                                         
  inputTree_mc  ->SetBranchAddress("IsoTrack_dedxUnSmearedByLayer4",  IsoTrack_dedxUnSmearedByLayer4);                                         
  
  inputTree_data->SetBranchAddress("IsoTrack_dedxUnSmearedByLayer5",  IsoTrack_dedxUnSmearedByLayer5);                                         
  inputTree_mc  ->SetBranchAddress("IsoTrack_dedxUnSmearedByLayer5",  IsoTrack_dedxUnSmearedByLayer5);                                         
  
  inputTree_data->SetBranchAddress("IsoTrack_dedxUnSmearedByLayer6",  IsoTrack_dedxUnSmearedByLayer6);                                         
  inputTree_mc  ->SetBranchAddress("IsoTrack_dedxUnSmearedByLayer6",  IsoTrack_dedxUnSmearedByLayer6);                                         
  
  inputTree_data->SetBranchAddress("IsoTrack_dedxUnSmearedByLayer7",  IsoTrack_dedxUnSmearedByLayer7);                                         
  inputTree_mc  ->SetBranchAddress("IsoTrack_dedxUnSmearedByLayer7",  IsoTrack_dedxUnSmearedByLayer7);                                         
  
  inputTree_data->SetBranchAddress("IsoTrack_dedxUnSmearedByLayer8",  IsoTrack_dedxUnSmearedByLayer8);                                         
  inputTree_mc  ->SetBranchAddress("IsoTrack_dedxUnSmearedByLayer8",  IsoTrack_dedxUnSmearedByLayer8);                                         
  
  inputTree_data->SetBranchAddress("IsoTrack_dedxUnSmearedByLayer9",  IsoTrack_dedxUnSmearedByLayer9);                                         
  inputTree_mc  ->SetBranchAddress("IsoTrack_dedxUnSmearedByLayer9",  IsoTrack_dedxUnSmearedByLayer9);                                         
  
  inputTree_data->SetBranchAddress("IsoTrack_dedxUnSmearedByLayer10",  IsoTrack_dedxUnSmearedByLayer10);                                       
  inputTree_mc  ->SetBranchAddress("IsoTrack_dedxUnSmearedByLayer10",  IsoTrack_dedxUnSmearedByLayer10);                                       
  
  inputTree_data->SetBranchAddress("IsoTrack_dedxUnSmearedByLayer11",  IsoTrack_dedxUnSmearedByLayer11);                                       
  inputTree_mc  ->SetBranchAddress("IsoTrack_dedxUnSmearedByLayer11",  IsoTrack_dedxUnSmearedByLayer11);                                       
  
  inputTree_data->SetBranchAddress("IsoTrack_dedxUnSmearedByLayer12",  IsoTrack_dedxUnSmearedByLayer12);                                       
  inputTree_mc  ->SetBranchAddress("IsoTrack_dedxUnSmearedByLayer12",  IsoTrack_dedxUnSmearedByLayer12);                                       
  
  inputTree_data->SetBranchAddress("IsoTrack_dedxUnSmearedByLayer13",  IsoTrack_dedxUnSmearedByLayer13);                                       
  inputTree_mc  ->SetBranchAddress("IsoTrack_dedxUnSmearedByLayer13",  IsoTrack_dedxUnSmearedByLayer13);                                       
        ...
        if (iEdge != -1) {
          ...
          if (IsoTrack_pixByLayer0[best_track] != 0) {  
            ...
            if ((ilayer >=0 && ilayer<layerId.size()) && (iladderblade>=0 && iladderblade<ladderbladeId.size())) {
              ...
              //               std::cout << " IsoTrack_dedxUnSmearedByLayer0 [" << best_track << "] = " << IsoTrack_dedxUnSmearedByLayer0 [best_track] << std::endl;
              //               std::cout << " IsoTrack_pixByLayer0 [" << best_track << "] = " << IsoTrack_pixByLayer0 [best_track] << std::endl;
              
              if (IsoTrack_pixByLayer0[best_track] == 1) {
                //---- BPIX
                map_h_BPIX_data[iRun][ilayer][iEdge][iladderblade] ->Fill(IsoTrack_dedxUnSmearedByLayer0 [best_track] * map_calibration_BPIX[iRun][ilayer][iEdge][iladderblade]); 
              }
              else {
                //---- FPIX
                map_h_FPIX_data[iRun][ilayer][iEdge][iladderblade] ->Fill(IsoTrack_dedxUnSmearedByLayer0 [best_track] * map_calibration_FPIX[iRun][ilayer][iEdge][iladderblade]); 
              }
            }
          }
          ...
          if (IsoTrack_pixByLayer1[best_track] != 0) {  
            ...
            if ((ilayer >=0 && ilayer<layerId.size()) && (iladderblade>=0 && iladderblade<ladderbladeId.size())) {
              ...
              //               std::cout << " map_h_FPIX_data[iRun][ilayer][iEdge][iladderblade] = " << map_h_FPIX_data[iRun][ilayer][iEdge][iladderblade] << " --> " << map_h_FPIX_data[iRun][ilayer][iEdge][iladderblade]->GetEntries() << std::endl;
              //               std::cout << " map_calibration_FPIX[iRun][ilayer][iEdge][iladderblade] = " << map_calibration_FPIX[iRun][ilayer][iEdge][iladderblade] << std::endl;
              //               std::cout << " IsoTrack_dedxUnSmearedByLayer1 [" << best_track << "] = " << IsoTrack_dedxUnSmearedByLayer1 [best_track] << std::endl;
              //               std::cout << " IsoTrack_pixByLayer1 [" << best_track << "] = " << IsoTrack_pixByLayer1 [best_track] << std::endl;
              
              if (IsoTrack_pixByLayer1[best_track] == 1) {
                //---- BPIX
                map_h_BPIX_data[iRun][ilayer][iEdge][iladderblade] ->Fill(IsoTrack_dedxUnSmearedByLayer1 [best_track] * map_calibration_BPIX[iRun][ilayer][iEdge][iladderblade]); 
              }
              else {
                //---- FPIX
                map_h_FPIX_data[iRun][ilayer][iEdge][iladderblade] ->Fill(IsoTrack_dedxUnSmearedByLayer1 [best_track] * map_calibration_FPIX[iRun][ilayer][iEdge][iladderblade]); 
              }
            }
          }
          ...
          if (IsoTrack_pixByLayer2[best_track] != 0) {  
            ...
            if ((ilayer >=0 && ilayer<layerId.size()) && (iladderblade>=0 && iladderblade<ladderbladeId.size())) {
              ...
              //               std::cout << " map_h_FPIX_data[iRun][ilayer][iEdge][iladderblade] = " << map_h_FPIX_data[iRun][ilayer][iEdge][iladderblade] << " --> " << map_h_FPIX_data[iRun][ilayer][iEdge][iladderblade]->GetEntries() << std::endl;
              //               std::cout << " map_calibration_FPIX[iRun][ilayer][iEdge][iladderblade] = " << map_calibration_FPIX[iRun][ilayer][iEdge][iladderblade] << std::endl;
              //               std::cout << " IsoTrack_dedxUnSmearedByLayer2 [" << best_track << "] = " << IsoTrack_dedxUnSmearedByLayer2 [best_track] << std::endl;
              //               std::cout << " IsoTrack_pixByLayer2 [" << best_track << "] = " << IsoTrack_pixByLayer2 [best_track] << std::endl;
              
              if (IsoTrack_pixByLayer2[best_track] == 1) {
                //---- BPIX
                map_h_BPIX_data[iRun][ilayer][iEdge][iladderblade] ->Fill(IsoTrack_dedxUnSmearedByLayer2 [best_track] * map_calibration_BPIX[iRun][ilayer][iEdge][iladderblade]); 
              }
              else {
                //---- FPIX
                map_h_FPIX_data[iRun][ilayer][iEdge][iladderblade] ->Fill(IsoTrack_dedxUnSmearedByLayer2 [best_track] * map_calibration_FPIX[iRun][ilayer][iEdge][iladderblade]); 
              }
            }
          }
          ...
          if (IsoTrack_pixByLayer3[best_track] != 0) {  
            ...
            if ((ilayer >=0 && ilayer<layerId.size()) && (iladderblade>=0 && iladderblade<ladderbladeId.size())) {
              ...
              //               std::cout << " map_h_FPIX_data[iRun][ilayer][iEdge][iladderblade] = " << map_h_FPIX_data[iRun][ilayer][iEdge][iladderblade] << " --> " << map_h_FPIX_data[iRun][ilayer][iEdge][iladderblade]->GetEntries() << std::endl;
              //               std::cout << " map_calibration_FPIX[iRun][ilayer][iEdge][iladderblade] = " << map_calibration_FPIX[iRun][ilayer][iEdge][iladderblade] << std::endl;
              //               std::cout << " IsoTrack_dedxUnSmearedByLayer3 [" << best_track << "] = " << IsoTrack_dedxUnSmearedByLayer3 [best_track] << std::endl;
              //               std::cout << " IsoTrack_pixByLayer3 [" << best_track << "] = " << IsoTrack_pixByLayer3 [best_track] << std::endl;
              
              if (IsoTrack_pixByLayer3[best_track] == 1) {
                //---- BPIX
                map_h_BPIX_data[iRun][ilayer][iEdge][iladderblade] ->Fill(IsoTrack_dedxUnSmearedByLayer3 [best_track] * map_calibration_BPIX[iRun][ilayer][iEdge][iladderblade]); 
              }
              else {
                //---- FPIX
                map_h_FPIX_data[iRun][ilayer][iEdge][iladderblade] ->Fill(IsoTrack_dedxUnSmearedByLayer3 [best_track] * map_calibration_FPIX[iRun][ilayer][iEdge][iladderblade]); 
              }
            }
          }
          ...
          if (IsoTrack_pixByLayer4[best_track] != 0) {  
            ...
            if ((ilayer >=0 && ilayer<layerId.size()) && (iladderblade>=0 && iladderblade<ladderbladeId.size())) {
              ...
              //               std::cout << " map_h_FPIX_data[iRun][ilayer][iEdge][iladderblade] = " << map_h_FPIX_data[iRun][ilayer][iEdge][iladderblade] << " --> " << map_h_FPIX_data[iRun][ilayer][iEdge][iladderblade]->GetEntries() << std::endl;
              //               std::cout << " map_calibration_FPIX[iRun][ilayer][iEdge][iladderblade] = " << map_calibration_FPIX[iRun][ilayer][iEdge][iladderblade] << std::endl;
              //               std::cout << " IsoTrack_dedxUnSmearedByLayer4 [" << best_track << "] = " << IsoTrack_dedxUnSmearedByLayer4 [best_track] << std::endl;
              //               std::cout << " IsoTrack_pixByLayer4 [" << best_track << "] = " << IsoTrack_pixByLayer4 [best_track] << std::endl;
              
              
              if (IsoTrack_pixByLayer4[best_track] == 1) {
                //---- BPIX
                map_h_BPIX_data[iRun][ilayer][iEdge][iladderblade] ->Fill(IsoTrack_dedxUnSmearedByLayer4 [best_track] * map_calibration_BPIX[iRun][ilayer][iEdge][iladderblade]); 
              }
              else {
                //---- FPIX
                map_h_FPIX_data[iRun][ilayer][iEdge][iladderblade] ->Fill(IsoTrack_dedxUnSmearedByLayer4 [best_track] * map_calibration_FPIX[iRun][ilayer][iEdge][iladderblade]); 
              }
            }
          }
          ...
          if (IsoTrack_pixByLayer5[best_track] != 0) {  
            ...
            if ((ilayer >=0 && ilayer<layerId.size()) && (iladderblade>=0 && iladderblade<ladderbladeId.size())) {
              ...
              //               std::cout << " map_h_FPIX_data[iRun][ilayer][iEdge][iladderblade] = " << map_h_FPIX_data[iRun][ilayer][iEdge][iladderblade] << " --> " << map_h_FPIX_data[iRun][ilayer][iEdge][iladderblade]->GetEntries() << std::endl;
              //               std::cout << " map_calibration_FPIX[iRun][ilayer][iEdge][iladderblade] = " << map_calibration_FPIX[iRun][ilayer][iEdge][iladderblade] << std::endl;
              //               std::cout << " IsoTrack_dedxUnSmearedByLayer5 [" << best_track << "] = " << IsoTrack_dedxUnSmearedByLayer5 [best_track] << std::endl;
              //               std::cout << " IsoTrack_pixByLayer5 [" << best_track << "] = " << IsoTrack_pixByLayer5 [best_track] << std::endl;
              
              
              if (IsoTrack_pixByLayer5[best_track] == 1) {
                //---- BPIX
                map_h_BPIX_data[iRun][ilayer][iEdge][iladderblade] ->Fill(IsoTrack_dedxUnSmearedByLayer5 [best_track] * map_calibration_BPIX[iRun][ilayer][iEdge][iladderblade]); 
              }
              else {
                //---- FPIX
                map_h_FPIX_data[iRun][ilayer][iEdge][iladderblade] ->Fill(IsoTrack_dedxUnSmearedByLayer5 [best_track] * map_calibration_FPIX[iRun][ilayer][iEdge][iladderblade]); 
              }
            }
          }
          ...
          if (IsoTrack_pixByLayer6[best_track] != 0) {  
            ...
            if ((ilayer >=0 && ilayer<layerId.size()) && (iladderblade>=0 && iladderblade<ladderbladeId.size())) {
              if (IsoTrack_pixByLayer6[best_track] == 1) {
                //---- BPIX
                map_h_BPIX_data[iRun][ilayer][iEdge][iladderblade] ->Fill(IsoTrack_dedxUnSmearedByLayer6 [best_track] * map_calibration_BPIX[iRun][ilayer][iEdge][iladderblade]); 
              }
              else {
                //---- FPIX
                map_h_FPIX_data[iRun][ilayer][iEdge][iladderblade] ->Fill(IsoTrack_dedxUnSmearedByLayer6 [best_track] * map_calibration_FPIX[iRun][ilayer][iEdge][iladderblade]); 
              }
            }
          }
          ...
          if (IsoTrack_pixByLayer0[best_track] != 0) {  
            ...
            if ((ilayer >=0 && ilayer<layerId.size()) && (iladderblade>=0 && iladderblade<ladderbladeId.size())) {
              if (IsoTrack_pixByLayer0[best_track] == 1) {
                ...
                map_h_BPIX_mc[iRun][ilayer][iEdge][iladderblade] ->Fill(IsoTrack_dedxUnSmearedByLayer0 [best_track] * additional_smearing); 
                ...
                map_h_FPIX_mc[iRun][ilayer][iEdge][iladderblade] ->Fill(IsoTrack_dedxUnSmearedByLayer0 [best_track] * additional_smearing); 
              }
            }
          }
          ...
          if (IsoTrack_pixByLayer1[best_track] != 0) {  
            ...
            if ((ilayer >=0 && ilayer<layerId.size()) && (iladderblade>=0 && iladderblade<ladderbladeId.size())) {
              if (IsoTrack_pixByLayer1[best_track] == 1) {
                ...
                map_h_BPIX_mc[iRun][ilayer][iEdge][iladderblade] ->Fill(IsoTrack_dedxUnSmearedByLayer1 [best_track] * additional_smearing); 
              }
              else {
                //---- FPIX
                float additional_smearing = 1.0;
                ...
                map_h_FPIX_mc[iRun][ilayer][iEdge][iladderblade] ->Fill(IsoTrack_dedxUnSmearedByLayer1 [best_track] * additional_smearing); 
              }
            }
          }
          ...
          if (IsoTrack_pixByLayer2[best_track] != 0) {  
            ...
            if ((ilayer >=0 && ilayer<layerId.size()) && (iladderblade>=0 && iladderblade<ladderbladeId.size())) {
              if (IsoTrack_pixByLayer2[best_track] == 1) {
                ...
                map_h_BPIX_mc[iRun][ilayer][iEdge][iladderblade] ->Fill(IsoTrack_dedxUnSmearedByLayer2 [best_track] * additional_smearing); 
              }
              else {
                //---- FPIX
                float additional_smearing = 1.0;
                ...
                map_h_FPIX_mc[iRun][ilayer][iEdge][iladderblade] ->Fill(IsoTrack_dedxUnSmearedByLayer2 [best_track] * additional_smearing); 
              }
            }
          }
          ...
          if (IsoTrack_pixByLayer3[best_track] != 0) {  
            ...
            if ((ilayer >=0 && ilayer<layerId.size()) && (iladderblade>=0 && iladderblade<ladderbladeId.size())) {
              if (IsoTrack_pixByLayer3[best_track] == 1) {
                ...
                map_h_BPIX_mc[iRun][ilayer][iEdge][iladderblade] ->Fill(IsoTrack_dedxUnSmearedByLayer3 [best_track] * additional_smearing); 
              }
              else {
                //---- FPIX
                float additional_smearing = 1.0;
                ...
                map_h_FPIX_mc[iRun][ilayer][iEdge][iladderblade] ->Fill(IsoTrack_dedxUnSmearedByLayer3 [best_track] * additional_smearing); 
              }
            }
          }
          ...
          if (IsoTrack_pixByLayer4[best_track] != 0) {  
            ...
            if ((ilayer >=0 && ilayer<layerId.size()) && (iladderblade>=0 && iladderblade<ladderbladeId.size())) {
              if (IsoTrack_pixByLayer4[best_track] == 1) {
                ...
                map_h_BPIX_mc[iRun][ilayer][iEdge][iladderblade] ->Fill(IsoTrack_dedxUnSmearedByLayer4 [best_track] * additional_smearing); 
              }
              else {
                //---- FPIX
                float additional_smearing = 1.0;
                ...
                map_h_FPIX_mc[iRun][ilayer][iEdge][iladderblade] ->Fill(IsoTrack_dedxUnSmearedByLayer4 [best_track] * additional_smearing); 
              }
            }
          }
          ...
          if (IsoTrack_pixByLayer5[best_track] != 0) {  
            ...
            if ((ilayer >=0 && ilayer<layerId.size()) && (iladderblade>=0 && iladderblade<ladderbladeId.size())) {
              if (IsoTrack_pixByLayer5[best_track] == 1) {
                ...
                map_h_BPIX_mc[iRun][ilayer][iEdge][iladderblade] ->Fill(IsoTrack_dedxUnSmearedByLayer5 [best_track] * additional_smearing); 
              }
              else {
                //---- FPIX
                float additional_smearing = 1.0;
                ...
                map_h_FPIX_mc[iRun][ilayer][iEdge][iladderblade] ->Fill(IsoTrack_dedxUnSmearedByLayer5 [best_track] * additional_smearing); 
              }
            }
          }
          ...
          if (IsoTrack_pixByLayer6[best_track] != 0) {  
            ...
            if ((ilayer >=0 && ilayer<layerId.size()) && (iladderblade>=0 && iladderblade<ladderbladeId.size())) {
              if (IsoTrack_pixByLayer6[best_track] == 1) {
                ...
                map_h_BPIX_mc[iRun][ilayer][iEdge][iladderblade] ->Fill(IsoTrack_dedxUnSmearedByLayer6 [best_track] * additional_smearing); 
              }
              else {
                //---- FPIX
                float additional_smearing = 1.0;
                ...
                map_h_FPIX_mc[iRun][ilayer][iEdge][iladderblade] ->Fill(IsoTrack_dedxUnSmearedByLayer6 [best_track] * additional_smearing); 
              }
            }
          }
